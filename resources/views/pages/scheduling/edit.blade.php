										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-md-9">
														<input type="text" name="contact" id="" class="form-control" value="{{ $schedule->contact }}" required>
													</div>
												</div>
												<div class="clearfix"></div><br />
												...
												<div class="row">
													...
													<div class="col-md-9">
														<input type="text" name="address" id="" class="form-control" value="{{ $schedule->address }}" required>
													</div>
												</div>
												<div class="clearfix"></div><br />
												...
												<div class="row">
													...
													<div class="col-md-9">
														<input type="number" name="age" id="" class="form-control" value="{{ $schedule->age }}" required>
													</div>
												</div>
												<div class="clearfix"></div><br />
												<div class="row">
