			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-6">
								<form class="" action="{{ route('app.inventory.out.process') }}" method="post">
									...
									<div class="row">
										...
										<div class="col-md-9">
											<select onchange="getQuantity()" name="inventory_id" id="inventory_id" class="form-control" required>
									...
									<div class="row">
										...
										<div class="col-md-9">
											<div id="quantity">Please select item</div>
										</div>
									</div>
									<div class="clearfix"></div><br />
